defmodule BooksApi.StoreTest do
  ...
  describe "books" do
    ...
    test "create_book/1 with valid data creates a book" do
      valid_attrs = %{" title": "some  title", authors: [], description: "some description", isbn: "some isbn", price: 120.5}
    ...
    test "update_book/2 with valid data updates the book" do
      book = book_fixture()
      update_attrs = %{" title": "some updated  title", authors: [], description: "some updated description", isbn: "some updated isbn", price: 456.7}
